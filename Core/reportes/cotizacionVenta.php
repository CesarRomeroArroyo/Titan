<?php
    ...
    $sql="SELECT * FROM quotation_head WHERE idunico='".$_GET["id"]."'";   
    $cabecera = consulta::convertir_a_array(consulta::ejecutar_consulta($sql));

    $sql="SELECT * FROM quotation_details WHERE idunico='".$_GET["id"]."'";   
    ...
    for ($i=0; $i < count($detalles); $i++) {
        ...
        $subtotal += (($detalles[$i]['vtotal'] / $detalles[$i]['cantidad']) / (1 + ($detalles[$i]['iva']/100))) * $detalles[$i]['cantidad'];
...
<page backtop="40mm" backbottom="90mm" backleft="0mm" backright="5mm" format="letter"> 
    ...
    <page_header>
        ...
        <div style="position:absolute;top:6;left:300;"><span class="ft2" style="font-size:20px;font-weight: bold;">COTIZACION</span></div>
        ...
        <table style="width:100%;" class="table">
            ...
            <?php 
                ...
                <tr class="<?php echo ($last ? 'tr-last' : ''); ?>">
                    <td class="t-body td_cod"><?php echo $product[0]["codigo"] ?></td>
                    <td class="t-body td_nom"><?php echo $product[0]["nombre"] ?></td>
                    <td class="t-body td_com"><?php echo $product[0]["nombre_comercial"] ?></td>
                    <td class="t-body td_lab"><?php echo $laboratorio[0]["nombre"] ?></td>
                    ...
                    <td class="t-body td_neto"><?php  ?></td>
