<?php
	...
	$sql="SELECT * FROM general_movimientos_head_output WHERE idunico='".$_GET["id"]."'";   
...
<page_header>
	<table border='0' style="font-size: 7pt;width: 100%;">
		<tr>
			...
			<td style="text-align: center; font-size: 13px;   width: 150px; height: 120px">SALIDA DE INVENTARIO<BR/>No <b><?php echo $cabecera[0]["id"] ?></b></td>
		</tr>
		<tr align='center'>
