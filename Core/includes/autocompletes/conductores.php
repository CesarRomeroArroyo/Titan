<?php require_once '../classes/consultaClass.php';
    $cie[0]='id';
    $cie[1]='CONCAT(pri_nom, " ", seg_nom , " ", pri_ape," ", seg_ape,"|",tip_ide,"|",num_ide) as nombre';
    $donde='CONCAT(num_ide, " ",pri_nom, " ", seg_nom , " ", pri_ape, " ", seg_ape)'. "LIKE '%". $_GET['term']. "%' AND state='1'";
      
    $SQL= consulta::seleccionar($cie, 'logistic_drivers', $donde);
